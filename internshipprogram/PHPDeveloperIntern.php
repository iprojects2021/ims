...
$sql = "SELECT * FROM programs WHERE title='PHP Developer Intern' AND status='upcoming'";
...
<head>
    ...
    <meta charset="UTF-8">
    <title>PHP Developer Intern | INDSAC SOFTECH</title>
...
<body>
    <div class="container py-5">
        ...
        <div class="program-hero p-4 mb-4">
            <div class="row">
                <div class="col-md-8">
                    <h1 id="program-title">PHP Development Internship</h1>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div id="responsibilities-list">
                            <div class="responsibility-item">
                                <h5><i class="fas fa-code me-2"></i> Develop and maintain PHP-based web applications</h5>
                                <p>Build scalable backend systems using modern PHP practices.</p>
                            </div>
                            <div class="responsibility-item">
                                <h5><i class="fas fa-bug me-2"></i> Debug and optimize existing Laravel codebases</h5>
                                <p>Learn to identify performance bottlenecks and security issues.</p>
                            </div>
                            <div class="responsibility-item">
                                <h5><i class="fas fa-database me-2"></i> Integrate MySQL databases with PHP applications</h5>
        ...
        function loadProgramData() {
            ...
            const programData = {
                ...
                responsibilities: [
                    ...
                    { title: "Integrate MySQL databases with PHP applications", desc: "Design efficient database schemas and write optimized queries." }
                ],
                schedule: [
