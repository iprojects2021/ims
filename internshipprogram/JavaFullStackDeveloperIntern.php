...
$sql = "SELECT * FROM programs WHERE title='Java Full Stack Developer Intern' AND status='upcoming'";
...
<head>
    ...
    <meta charset="UTF-8">
    <title>Java Full Stack Developer Intern | INDSAC SOFTECH</title>
        ...
        <div class="program-hero p-4 mb-4">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p class="lead" id="program-short-desc">1-6 months remote internship to build real Java Full-Stack projects with mentorship</p>
                </div>
    ...
    <script>
        ...
        function loadProgramData() {
            ...
            const programData = {
                ...
                shortDesc: "1-6 months remote internship to build real Java Full-Stack projects with mentorship",
