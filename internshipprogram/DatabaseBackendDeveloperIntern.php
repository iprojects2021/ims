...
$sql = "SELECT * FROM programs WHERE title='Database Backend Developer Intern' AND status='upcoming'";
...
<head>
    ...
    <meta charset="UTF-8">
    <title>Database Backend Developer Intern | INDSAC SOFTECH</title>
