                    ...
                    <div class="col-lg-8">
                        ...
                        <div id="responsibilities-list">
                            <div class="responsibility-item">
                                <h5><i class="fas fa-code me-2"></i> Develop and train AI/ML models using Python.</h5>
                                <p>Build intelligent applications with Natural Language Processing (NLP) and Computer Vision.</p>
                            </div>
                            <div class="responsibility-item">
                                <h5><i class="fas fa-bug me-2"></i> Debug and optimize machine learning models for accuracy and performance.</h5>
                    ...
                    <div class="col-md-6">
                        ...
                        <div id="outcomes-list">
                            <div class="outcome-item mb-3">
                                <h5>AI & Machine Learning Fundamentals</h5>
                                <p>Understand the core concepts of AI, supervised and unsupervised learning, and model evaluation.</p>
                            </div>
                            <div class="outcome-item mb-3">
                                <h5>Data Preprocessing & Feature Engineering</h5>
                                <p>Learn techniques to clean, preprocess, and transform raw data into usable formats for AI models.</p>
                            </div>
                            <div class="outcome-item mb-3">
                                <h5>Natural Language Processing (NLP)</h5>
                                <p>Build applications that can analyze, process, and understand human language.</p>
                            </div>
                            <div class="outcome-item mb-3">
                ...
                <div class="row row-cols-1 row-cols-md-2 g-4" id="projects-list">
                    <div class="col">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"> Smart Chatbot for Customer Support </h5>
                                <h6 class="card-subtitle mb-2 text-muted">Python, Rasa, NLP, FastAPI</h6>
                                <p class="card-text">Develop a chatbot capable of understanding queries, providing answers, and escalating issues when needed.</p>
                                <ul class="list-group list-group-flush mb-3">
                                    <li class="list-group-item"><i class="fas fa-check-circle text-success me-2"></i> Implement NLP-based intent recognition.</li>
                                    <li class="list-group-item"><i class="fas fa-check-circle text-success me-2"></i> Train the model with real customer support data.</li>
                                    <li class="list-group-item"><i class="fas fa-check-circle text-success me-2"></i> Enable multi-turn conversations with context retention.</li>
                                    <li class="list-group-item"><i class="fas fa-check-circle text-success me-2"></i> Deploy chatbot APIs for web/mobile integration.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush mb-3">
                                    <li class="list-group-item"><i class="fas fa-check-circle text-success me-2"></i> Train CNN models on agricultural datasets.</li>
                                    ...
                                    <li class="list-group-item"><i class="fas fa-check-circle text-success me-2"></i> Build a farmer-friendly mobile/web app.</li>
                                    <li class="list-group-item"><i class="fas fa-check-circle text-success me-2"></i> Deploy with TensorFlow Lite for edge devices.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Apply for <span id="modal-program-title">AI Developer Internship</span></h5>
    ...
    <script>
        ...
        function loadProgramData() {
            ...
            const programData = {
                ...
                shortDesc: "3-month remote internship to build real AI projects with mentorship",
                ...
                deadline: "Nov 3, 2025",
                responsibilities: [
                    { title: "Develop and train AI/ML models using Python.", desc: "Build intelligent applications with Natural Language Processing (NLP) and Computer Vision." },
                    { title: "Debug and optimize machine learning models for accuracy and performance.", desc: "Learn to identify data quality issues and apply preprocessing techniques." },
                    { title: "Integrate AI models into applications through REST APIs.", desc: "Deploy AI solutions on cloud platforms for scalability and real-world usage." }
                ],
                schedule: [
                ...
                outcomes: [
                    { title: "AI & Machine Learning Fundamentals", desc: "Understand the core concepts of AI, supervised and unsupervised learning, and model evaluation." },
                    { title: "Data Preprocessing & Feature Engineering", desc: "Learn techniques to clean, preprocess, and transform raw data into usable formats for AI models." },
                    { title: "Natural Language Processing (NLP)", desc: "Build applications that can analyze, process, and understand human language." },
                    { title: "Model Deployment & Integration", desc: "Deploy trained AI/ML models into real-world applications using REST APIs and cloud services." }
                ],
                projects: [
                    { 
                        title: "Smart Chatbot for Customer Support", 
                        tech: "Python, Rasa, NLP, FastAPI", 
                        desc: "Develop a chatbot capable of understanding queries, providing answers, and escalating issues when needed.",
                        features: [
                            "Implement NLP-based intent recognition.",
                            "Enable multi-turn conversations with context retention.",
                            "Train the model with real customer support data.",
                            "Deploy chatbot APIs for web/mobile integration."
                        ]
                    },
                    { 
                        ...
                        features: [
                            "Train CNN models on agricultural datasets.",
                            "Classify diseases and suggest preventive measures.",
                            "Build a farmer-friendly mobile/web app.",
                            "Deploy with TensorFlow Lite for edge devices."
                        ]
                    }
                ],
                faqs: [
