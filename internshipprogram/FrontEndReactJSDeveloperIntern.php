...
$sql = "SELECT * FROM programs WHERE title='Front End ReactJS Developer Intern' AND status='upcoming'";
...
<head>
    ...
    <meta charset="UTF-8">
    <title>Front End ReactJS Developer Intern | INDSAC SOFTECH</title>
...
<body>
    <div class="container py-5">
        ...
        <div class="program-hero p-4 mb-4">
            <div class="row">
                <div class="col-md-8">
                    <h1 id="program-title">Front End ReactJS Development Internship</h1>
                    <p class="lead" id="program-short-desc">1-6 months remote internship to build real Front End ReactJS projects with mentorship</p>
                </div>
    ...
    <script>
        ...
        function loadProgramData() {
            ...
            const programData = {
                ...
                shortDesc: "1-6 months remote internship to build real Front End ReactJS projects with mentorship",
                description: "Transform your academic knowledge into industry-ready skills with our flexible internship training program. Work on live projects with expert mentors.\n\n A Front-End ReactJS Developer builds interactive and responsive web applications using ReactJS, focusing on delivering seamless user experiences. They implement UI components, manage state efficiently, and integrate with backend APIs.\n\nYou'll work directly with senior developers, participate in code reviews, and build portfolio-worthy projects that solve actual business problems.",
                duration: "1 - 6 months",
