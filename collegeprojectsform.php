                ...
                <div class="form-container">
                    ...
                    <form id="projectForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" id="mobile" placeholder="e.g., +91 9876543210" required>
                        </div>

                        <!-- Email -->
                        <div class="mb-3">
                            <label for="email" class="form-label">Email*</label>
                            <input type="email" class="form-control" id="email" placeholder="e.g., student@example.com" required>
                        </div>

                        <!-- Project Description -->
                        <div class="mb-3">
                            <label for="description" class="form-label">Project Description/Idea*</label>
                            <textarea class="form-control" id="description" rows="4" placeholder="Describe your project idea in detail..." required></textarea>
                        </div>

                        <!-- Expected Outcome -->
                        <div class="mb-3">
                            <label for="outcome" class="form-label">Expected Outcome*</label>
                            <textarea class="form-control" id="outcome" rows="3" placeholder="What do you hope to achieve with this project?" required></textarea>
                        </div>
