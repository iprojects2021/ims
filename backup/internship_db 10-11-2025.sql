...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 11, 2025 at 05:28 PM
...
CREATE TABLE `enrollments` (
  ...
  `enrolleduseremail` varchar(1000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
-- Table structure for table `evaluationfeedbackanswer`
--
...
CREATE TABLE `evaluationfeedbackanswer` (
  ...
  `initiative_score` int(11) DEFAULT NULL,
  `teamwork_score` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `evaluationfeedbackanswer`
--
...
CREATE TABLE `questions` (
  ...
  `textans` varchar(1000) DEFAULT NULL,
  `status` varchar(50) DEFAULT 'active',
  `createdate` timestamp NOT NULL DEFAULT current_timestamp(),
  `ratemax` int(11) DEFAULT 5
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Table structure for table `referralpaymentpayout`
--

CREATE TABLE `referralpaymentpayout` (
  `id` int(11) NOT NULL,
  `applicationid` int(11) NOT NULL,
...
--
-- Dumping data for table `referralpaymentpayout`
--
...
CREATE TABLE `users` (
  ...
  `upiid` varchar(1000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
-- Indexes for table `evaluationfeedbackanswer`
--
ALTER TABLE `evaluationfeedbackanswer`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `referralpaymentpayout`
--
ALTER TABLE `referralpaymentpayout`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `evaluationfeedbackanswer`
--
ALTER TABLE `evaluationfeedbackanswer`
...
--
ALTER TABLE `paymentverification`
  MODIFY `PaymentVerificationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=335;

--
-- AUTO_INCREMENT for table `programs`
--
ALTER TABLE `programs`
  MODIFY `program_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=340;
...
--
-- AUTO_INCREMENT for table `referralpaymentpayout`
--
ALTER TABLE `referralpaymentpayout`
